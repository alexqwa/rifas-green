...
export function Navbar() {
  ...
  return (
    <div className="sticky top-0 flex items-center z-[9998] justify-between px-8 h-[76px] backdrop-blur-md backdrop-saturate-[180%] bg-white border-b border-rifas-border-line">

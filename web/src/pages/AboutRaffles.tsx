import { Article, Bank, ListNumbers, Phone, SelectionAll } from "phosphor-react"
...
export function AboutRaffles() {
  return (
    <>
      <Navbar />
      <div className="w-full max-w-[1152px] m-auto pt-12">
              ...
              <form className="flex flex-col">
                <div className="grid grid-cols-2 gap-2">
                  <div className="flex flex-col gap-1">
                    ...
                    <Input placeholder="Título do produto" type="category">
                      <Article
                        size={16}
                        weight="fill"
